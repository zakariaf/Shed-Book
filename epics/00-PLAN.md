...
| **E02** | The gate | 1 | E01 | **L · ~700 lines, one file.** `tool/check_policy.dart`, its allowlist and its self-tests | `dart tool/check_policy.dart` exits 0; plant any violation and it exits 1 naming the rule id — **every rule has been seen to fire** |
