...
§1.5 (**closed 2026-08-02** — `stream.invalidate` narrowed to exclude `minuteTickProvider` and
`databaseProvider`; a red one on any other argument is a real defect), §1.10
