...
| **N03** | [The gate](N03-the-gate/epic.md) | `tool/check_policy.dart` — ~30 rules, one allowlist, one exit code, each rule watched to fire | `dart tool/check_policy.dart` exits 0 on the tree; plant any violation and it exits 1 naming the rule id. … | N02 | L · 7 tasks |
